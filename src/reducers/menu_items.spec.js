...
describe('reducers/menu_items', () => {
    ...
    it('should return a state containing the given menu item when reducing an addMenuItem action', () => {
        var state = {};
    ...
    it('should preserve existing state entries when reducing an addMenuItem action', () => {
        var state = {
            1111: {
                id: 1111,
                name: 'Burger',
